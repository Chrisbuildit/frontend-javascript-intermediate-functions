...
// Je gaat functies schrijven die we kunnen hergebruiken om een lijst met eindcijfers van studenten te checken. Je
// zult over de cijfers heen moeten itereren (hoe pak je dat aan?),
...
//Counter needs to be declared outside function for function to work
...
// * Hoe zorgt ik ervoor dat ik alle waardes uit de array kan langslopen, ook als de array wel 100 entries zou
// bevatten?
// Log het antwoord in de terminal.
...
function average(cijferLijst) {
    let count = 0;
    let som = 0;
    let i = 0;
    for (i; i < cijferLijst.length; i++) {
        count++;
        som += cijferLijst[i];
    }
    return som/count;
}
const cijferLijst = [6, 4, 5];
console.log(average(cijferLijst));

/* 2c: Afronden op twee decimalen */
// Zorg ervoor dat het gemiddelde cijfer dat wordt teruggegeven uit de functie netjes wordt afgerond op twee decimalen.
// Tip: Google is your best friend!

let outcome = average(cijferLijst);
